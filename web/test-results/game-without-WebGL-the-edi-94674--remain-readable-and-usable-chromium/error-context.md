...
- Name: game.spec.ts >> without WebGL the editor and validation remain readable and usable
- Location: tests/e2e/game.spec.ts:54:1
...
Locator: locator('.webgl-fallback')
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" locator('.webgl-fallback') with timeout 10000ms
  - waiting for locator('.webgl-fallback')

```

```yaml
- banner:
  - button "caffeine protocol A LITTLE LOGIC. A LOT OF HEART.":
    - img
    - text: caffeine protocol A LITTLE LOGIC. A LOT OF HEART.
  - text: YOUR NEIGHBORHOOD CAFÉ
  - img
  - text: 0 / 36
  - button "Settings":
    - img
- navigation "Main navigation":
  ...
  - button "Campaign":
    - img
  - text: ACT I
  - button "Selected shift":
    - img
  - button "Game guide":
    - img
  - button "Audio and display settings":
    - img
  - img
- main:
  - button "Campaign / Shift 03":
    - img
    - text: Campaign / Shift 03
  - heading "Boot Sequence QUERY / ORDER INTAKE" [level=1]
  - button "Help":
    - img
    - text: Help
  - button "Options":
    - img
    - text: Options
  - text: MORNING SERVICE 3 TABLES · QUERY ONLINE
  - img
  - text: EST. TODAY
  - strong: A fresh shift awaits
  - text: The kettle is warm. Your instructions make the difference.
  - button "Pause playback" [disabled]:
    - img
    - text: Pause
  - button "1× playback": 1×
  - button "2× playback": 2×
  - button "4× playback": 4×
  - progressbar "Replay progress"
  - button "Inspect" [disabled]:
    - img
    - text: Inspect
  - img
  - text: YOUR OBJECTIVE
  - status "Service status": Wait for one customer speech event, then create one coffee ticket.
  - region "Query program editor":
    - text: Q ••
    - heading "Query’s routine" [level=2]
    - text: A LITTLE LOGIC GOES A LONG WAY READY
    - button "Blocks":
      - img
      - text: Blocks
    - button "Text":
      ...
      - text: Text
    - text: 4 / 128 blocks
    - button "Drag block 1 and its group":
      - img
      - text: "01"
    - combobox "Block 1":
      - option "Wait for customer speech" [selected]
      - option "Create ticket"
      - 'option "Set item: coffee"'
      - option "Submit ticket"
    - button "Move block 1 up" [disabled]:
      - img
    - button "Move block 1 down":
      - img
    - button "Delete block 1":
      - img
    - button "Drag block 2 and its group":
      - img
      - text: "02"
    - combobox "Block 2":
      - option "Wait for customer speech"
      - option "Create ticket" [selected]
      - 'option "Set item: coffee"'
      - option "Submit ticket"
    - button "Move block 2 up":
      - img
    - button "Move block 2 down":
      - img
    - button "Delete block 2":
      - img
    - button "Drag block 3 and its group":
      - img
      - text: "03"
    - combobox "Block 3":
      - option "Wait for customer speech"
      - option "Create ticket"
      - 'option "Set item: coffee" [selected]'
      - option "Submit ticket"
    - button "Move block 3 up":
      - img
    - button "Move block 3 down":
      - img
    - button "Delete block 3":
      - img
    - button "Drag block 4 and its group":
      - img
      - text: "04"
    - combobox "Block 4":
      - option "Wait for customer speech"
      - option "Create ticket"
      - 'option "Set item: coffee"'
      - option "Submit ticket" [selected]
    - button "Move block 4 up":
      - img
    - button "Move block 4 down":
      - img
    - button "Delete block 4":
      - img
    - button "+ Select a block to insert after it"
    - status
    - text: INSTRUCTION LIBRARY Add at the end
    - combobox "INSTRUCTION LIBRARY Add at the end":
      - option "Wait for customer speech"
      - option "Create ticket" [selected]
      - 'option "Set item: coffee"'
      - option "Submit ticket"
    ...
    - button "Run service ⌘ ↵":
      - img
      - text: Run service ⌘ ↵
    - text: Saved locally · Made with care
```

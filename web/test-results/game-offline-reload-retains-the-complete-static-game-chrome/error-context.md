...
Locator: getByRole('heading', { name: 'Good coffee. Better instructions.' })
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByRole('heading', { name: 'Good coffee. Better instructions.' }) with timeout 10000ms
  - waiting for getByRole('heading', { name: 'Good coffee. Better instructions.' })

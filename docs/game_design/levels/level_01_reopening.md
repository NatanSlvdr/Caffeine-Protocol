...
- Active tables: 2 of the cafe's 20+ tables.
- Customers: 3.
- Menu: coffee only.
- Query: visible as broken/inactive near the counter or repair bay.
- Programming editor: locked, with a note that robot programming is unavailable.
...
- The player opens the ticket debug toggle at least once.
